...
require 'homebus-aqi/options'
require 'homebus-aqi/app'

require 'homebus/config'

class TestHomebusAqi < HomebusAqi::App
...
describe HomebusAqi do
  context "Version number" do
    it "Has a version number" do
      expect(HomebusAqi::VERSION).not_to be_nil
      expect(HomebusAqi::VERSION.class).to be String
    end
  end 
end

describe HomebusAqi::Options do
  context "Methods" do
    ...
    it "Uses the VERSION constant" do
      expect(options.version).to eq(HomebusAqi::VERSION)
    end
